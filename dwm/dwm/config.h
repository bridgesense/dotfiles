...
/* modifier                     key        function        argument */
    ...
    { 0, XF86XK_AudioRaiseVolume,              spawn,          SHCMD("amixer -c 1 -- sset Master 2%+") },
    { 0, XF86XK_AudioLowerVolume,              spawn,          SHCMD("amixer -c 1 -- sset Master 2%-") },
    { 0, XF86XK_AudioMicMute,                  spawn,          SHCMD("amixer -c 1 -- sset Capture toggle") },

...
local browser          = os.getenv("BROWSER") or "chromium-freeworld"
...
local mymainmenu = freedesktop.menu.build({
  ...
  before = {
    { "Awesome", myawesomemenu, beautiful.awesome_icoj },
...
local keybindings = {
  ...
  {{}, "XF86MonBrightnessDown", function() awful.spawn("cbacklight --dec 5") end},
  {{}, "XF86MonBrightnessUp", function() awful.spawn("cbacklight --inc 5") end},
...
modes.launcher = gears.table.join(
  {
    ...
    },
    {
      ...
      pattern = { "F5" },
      handler = function() awful.spawn("cbacklight --dec 10") end
    },
    {
      description = "increase backlight",
      pattern = { "F6" },
      handler = function() awful.spawn("cbacklight --inc 10") end
    },
    {
    ...
    {
      description = "launch nemo",
      pattern = {'N'},
      handler = function() awful.spawn("nemo --no-desktop") end
    },
    {
      description = "launch bpytop",
      pattern = {'p'},
      handler = function() awful.spawn(terminal.." -e bpytop") end
    },
    {
      description = "Restart",
      pattern = {'R'},
      handler = function() awful.spawn.with_shell("bash -c `if zenity --question --text=\"Are you sure you want to restart?\"; then systemctl reboot; fi`") end
    },
    {
      description = "take screenshot",
      pattern = {'S'},
      handler = function() awful.spawn("flameshot gui") end
    },
    {
    ...
    },
    {
      ...
      pattern = {'X'},
      handler = function() awful.spawn.with_shell("bash -c `if zenity --question --text=\"Are you sure you want to power down?\"; then systemctl poweroff; fi`") end
    },
    {
